...
`;const t=["https://cdn.jsdelivr.net/gh/journey-ad/blog-img@94eb7e2/live2d/lib/pio.css","https://cdn.jsdelivr.net/npm/greensock@1.20.2/dist/TweenLite.js","https://cubism.live2d.com/sdk-web/cubismcore/live2dcubismcore.min.js","https://cdn.jsdelivr.net/npm/pixi.js@5.3.6/dist/pixi.min.js","https://cdn.jsdelivr.net/npm/pixi-live2d-display@0.3.1/dist/cubism4.min.js","https://cdn.jsdelivr.net/gh/journey-ad/blog-img@94eb7e2/live2d/lib/pio_sdk4.js","https://cdn.jsdelivr.net/gh/journey-ad/blog-img@94eb7e2/live2d/lib/pio.js"];const o=t.map(t=>s(t));const n=o.reduce((t,e)=>t.then(()=>e()),Promise.resolve());n.then(()=>{const t=document.getElementById("my-dear-haruna-vm");t&&t.remove();_pio_initialize_pixi();l(e);i();console.log("all done.")});const r={mode:"fixed",hidden:true,content:{skin:["0","1"],custom:[{selector:".most-viewed-panel .most-viewed-item, .live-up-list .live-detail, .card .user-name, .user .name, .post-content .content-full a, .tag-list .content, .title, h2 a[title]",type:"link"}]},model:["https://cdn.jsdelivr.net/gh/journey-ad/blog-img/live2d/Diana/Diana.model3.json"],tips:true,onModelLoad:a};let d;function i(){d=new Paul_Pio(r);pio_alignment="left";const t=document.querySelector(".pio-container .pio-action .pio-close");t.insertAdjacentHTML("beforebegin",'<span class="pio-top"></span>');const e=document.querySelector(".pio-container .pio-action .pio-top");e.onclick=function(){window.scrollTo({top:0,behavior:"smooth"})};pio_refresh_style()}function a(t){const e=document.getElementById("pio");const o=t.internalModel.settings.name;const n=t.internalModel.coreModel;const i=t.internalModel.motionManager;requestAnimationFrame(()=>{const t=document.getElementById("pio-container");if(t)t.classList.add("pio-ready")});let a=[{motion:"Idle"},{motion:"Idle"}];function c(o){o.text&&d.modules.render(o.text);o.motion&&d.model.motion(o.motion);if(o.from&&o.to){Object.keys(o.from).forEach(t=>{const e=n._partIds.indexOf(t);TweenLite.to(n._partOpacities,.6,{[e]:o.from[t]})});i.once("motionFinish",t=>{Object.keys(o.to).forEach(t=>{const e=n._partIds.indexOf(t);TweenLite.to(n._partOpacities,.6,{[e]:o.to[t]})})})}}e.onclick=function(){if(i.state.currentGroup!=="Idle")return;const t=d.modules.rand(a);c(t)};if(o==="Diana"){r.content.skin[1]=[];c({motion:"Tap抱阿草-左手"});a=[{motion:"Tap生气 -领结"},{motion:"Tap= =  左蝴蝶结"},{motion:"Tap哭 -眼角"},{motion:"Tap害羞-中间刘海"},{motion:"Tap抱阿草-左手"},{motion:"Tap摇头- 身体"},{motion:"Tap耳朵-发卡"},{motion:"Leave"},{motion:"Tap右头发"}]}else if(o==="Ava"){r.content.skin[1]=["我是<s>拉胯</s>Gamer担当 向晚 AvA~","怎么推流辣！","AAAAAAAAAAvvvvAAA 向晚！"];c({motion:"Tap左眼",from:{Part15:1},to:{Part15:0}});a=[{text:"水母 水母~ 只是普通的生物",motion:"Tap右手"},{text:"可爱的鸽子鸽子~我喜欢你~",motion:"Tap胸口项链",from:{Part12:1},to:{Part12:0}},{text:"好...好兄弟之间喜欢很正常啦",motion:"Tap中间刘海",from:{Part12:1},to:{Part12:0}},{text:"啊啊啊！怎么推流辣",motion:"Tap右眼",from:{Part16:1},to:{Part16:0}},{text:"你怎么老摸我，我的身体是不是可有魅力",motion:"Tap嘴"},{text:"AAAAAAAAAAvvvvAAA 向晚！",motion:"Tap左眼",from:{Part15:1},to:{Part15:0}}];e.width=t.width*1.2;t.x=e.width-t.width;const s=["Part5","neko","game","Part15","Part21","Part22","Part","Part16","Part12"];const l=s.map(t=>n._partIds.indexOf(t));l.forEach(t=>{n._partOpacities[t]=0})}}function c(){try{return window.self!==window.top}catch(t){return true}}function s(c){return()=>{return new Promise(function(t,e){const o=c.split(".").pop();let n=null;let i=false;if(o==="js"){n=document.createElement("script");n.type="text/javascript";n.src=c;n.async=true}else if(o==="css"){n=document.createElement("link");n.rel="stylesheet";n.type="text/css";n.href=c}n.onerror=function(t){e(t,n)};n.onload=n.onreadystatechange=function(){if(!i&&(!this.readyState||this.readyState=="complete")){i=true;console.log(c);t()}};const a=document.getElementsByTagName("script")[0];a.parentElement.insertBefore(n,a)})}}function l(t){if(typeof GM_addStyle!="undefined"){GM_addStyle(t)}else if(typeof PRO_addStyle!="undefined"){PRO_addStyle(t)}else{const e=document.createElement("style");e.type="text/css";e.appendChild(document.createTextNode(t));const o=document.getElementsByTagName("head");if(o.length>0){o[0].appendChild(e)}else{document.documentElement.appendChild(e)}}}})();